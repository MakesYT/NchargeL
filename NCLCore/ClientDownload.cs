...
namespace NCLCore
{
    public class ClientDownload
    {
        ...
        public void DownloadNchargeClient(NchargeClient nchargeClient, string DownloadSoureURL, string rootdir)
        {
            ...
            string output = JsonConvert.SerializeObject(jObject1, Formatting.Indented);
            ...
            string re1 = HttpRequestHelper.GetResponseString(HttpRequestHelper.CreatePostHttpResponse(
                "http://download.ncserver.top:8000/NCL/clients/" + nchargeClient.name + "/" +
