...
namespace NCLCore
{
    public class SDK
    {
        ...
        " --username TEST --version "+clt.McVer+" --gameDir \"" + clt.dir + "\" --assetsDir \"" + clt.rootdir + "\\assets\" --assetIndex " + clt.assets + " --versionType NCL" +
        " --uuid b28e05e703a236e5b101e61761ec80ee --accessToken 41495b2588624230beba0583a1505d7b --userProperties {} --userType mojang --width 854 --height 480";
            all = all.Replace("\\", "/");
            all = all.Replace("//", "/");
            all = all.Replace("/", "\\");
            ...
            return ExecuteInCmd(all, clt.rootdir + "\\versions\\" + clt.Name);
            //return all;
        }
